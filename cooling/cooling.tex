...
$\Delta_\perp=-\gamma/2 +\omega_rdk$. Steve et al \todo{cite
...
interference or polarization gradient effects~\todo{Is that
  reasonable? Is broad band the reason we don't have to worry
  about interference? Are we doing lin-perp-lin for axial beams?}
...
vibrational spectrum. \todo{Why are some modes affected by this
  while others aren't? Does that have to do with mode
  symmetries?}. Another possible explanation of the resonance
shifts is that they are caused by non-linear shifts such as the
Kerr effect \todo{Is that plausible? Only some modes shift due to
symmetry again? Are the level shifts in the right ball park for
this to be a possible explanation?}
